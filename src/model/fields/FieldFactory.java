...
public class FieldFactory {
	...
	public static Field[] makefields(GUI_Field[] guiFields){
		...
		for(int i = 0; i < fields.length && i < guiFields.length; i++){
